    ...
    default: () => [
      {
        ...
        link: "https://www.facebook.com/profile.php?id=100007025237162"
      },
      {
      ...
      },
      {
        ...
        link: "https://github.com/JEEVANRAWAL"
      },
      {
        icon: '<i class="fab fa-youtube text-lg opacity-8"></i>',
        link: "https://www.youtube.com/@jeevanrawal4360"
      }
    ]
  },
  menus: {
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              ...
              <a href="https://www.jeevanrawal.com.np" target="_blank"
                >Jeevan Rawal</a
              >.
            </p>
          </div>
